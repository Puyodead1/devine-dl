...
from devine.MSL.MSLObject import MSLObject
...
class KeyExchangeRequest(MSLObject):
    ...
    def Widevine(cls, keyrequest):
        ...
        return cls(
            scheme=KeyExchangeSchemes.Widevine, keydata={"keyrequest": keyrequest}
        )
    ...
    def PlayReady(cls, keyrequest):
        ...
        if not isinstance(keyrequest, str):
            keyrequest = base64.b64encode(keyrequest).decode()
        return cls(
            scheme=KeyExchangeSchemes.PlayReady, keydata={"keyrequest": keyrequest}
        )
